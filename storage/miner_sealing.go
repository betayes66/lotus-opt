...
func (m *Miner) PledgeStart() error {
	return m.sealing.PledgeStart()
}

func (m *Miner) PledgeStatus() (int, error) {
	return m.sealing.PledgeStatus()
}

func (m *Miner) PledgeStop() error {
	return m.sealing.PledgeStop()
}
